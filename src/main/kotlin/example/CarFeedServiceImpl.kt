...
import com.jaco.example.car.CarOuterClass.Car.Color.ColorType
import com.jaco.example.car.CarOuterClass.Car.Feature.FeatureType
...
internal class CarFeedServiceImpl : CarFeedServiceGrpcKt.CarFeedServiceCoroutineImplBase() {
  ...
  override fun getCarFeed(request: CarFeedServiceOuterClass.GetCarFeedRequest): Flow<CarFeed> {
    return flow {
      while (true) {
        emit(feedGenerator.generateRecord())
  ...
  internal class FeedGenerator {

    fun generateRecord(): CarFeed = carFeed {
